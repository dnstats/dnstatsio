...
class TestCaa(unittest.TestCase):
    def test_no_caa(self):
        self.assertEqual(0, grade_caa([], 'example.com'))

    def test_one_issue(self):
        caas = ['0 issue "letsencrypt.org"']
        self.assertEqual(85, grade_caa(caas, 'example.com'))
    ...
    def test_two_issue_iodef(self):
        ...
        self.assertEqual(90, grade_caa(caas, 'example.com'))
    ...
    def test_two_issue_iodef_issuewild(self):
        ...
        self.assertEqual(100, grade_caa(caas, 'example.com'))
    ...
    def test_two_issue_bad_iodef_issuewild(self):
        ...
        self.assertEqual(93, grade_caa(caas, 'example.com'))
